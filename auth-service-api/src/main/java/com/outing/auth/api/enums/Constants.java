package com.outing.auth.api.enums;
...
public interface Constants {
    ...
    String NOSPECIALCHAR_PASSWORD = "Password should contain atleast one special character";

    String NOTLONG_PASSWORD = "Password should be atleast 8 characters";
